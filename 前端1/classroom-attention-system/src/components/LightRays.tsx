...
type RayOrigin = 'top-left' | 'top-right' | 'left' | 'right' | 'bottom-left' | 'bottom-center' | 'bottom-right' | 'top-center';

const getAnchorAndDir = (origin: RayOrigin, w: number, h: number) => {
  const outside = 0.2;
  switch (origin) {
    case 'top-left':
